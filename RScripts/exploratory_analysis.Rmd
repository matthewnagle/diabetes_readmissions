...
## Logistic regression
```{r, tidy=TRUE, tidy.opts=list(width.cutoff=50)}
lg_model = ml_logistic_regression(diabetic_data_training, early_readmission ~
                                        diag_1_infection +
                                        diag_1_neoplasms +
...
```{r, tidy=TRUE, tidy.opts=list(width.cutoff=50)}
gbt_model = ml_gradient_boosted_trees(diabetic_data_training, early_readmission ~
                                        diag_1_infection +
                                        diag_1_neoplasms +
                                        diag_1_endo_metabolic_immunity +
                                        diag_1_haematology +
...
```{r, tidy=TRUE, tidy.opts=list(width.cutoff=50)}
mlp_model = ml_multilayer_perceptron_classifier(diabetic_data_training, early_readmission ~
                                        diag_1_infection +
                                        diag_1_neoplasms +
                                        diag_1_endo_metabolic_immunity +
                                        diag_1_haematology +
